...
//        if(!((HttpServletRequest) servletRequest).getServletPath().toLowerCase().equals("/caslogin.jsp"))
//            ((HttpServletResponse) servletResponse).sendRedirect("http://192.168.221.128:8080/test/caslogin.jsp");
