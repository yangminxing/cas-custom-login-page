 ...
 * for authentication, and on success populates a {@link javax.security.auth.Subject} with principal
 ...
 * {@link javax.security.auth.callback.PasswordCallback} and {@link javax.security.auth.callback.NameCallback}, respectively, by the
 * {@link javax.security.auth.callback.CallbackHandler} that is part of the JAAS framework in which the servlet
 * resides.
 *
 * <p>
