...
/**
 * Implementation of {@link org.jasig.cas.client.proxy.ProxyGrantingTicketStorage} that is backed by a
 * HashMap that keeps a ProxyGrantingTicket for a specified amount of time.
 * <p>
 * {@link org.jasig.cas.client.proxy.ProxyGrantingTicketStorage#cleanUp()} must be called on a regular basis to
...
public final class ProxyGrantingTicketStorageImpl implements ProxyGrantingTicketStorage {
    ...
    /**
     * time, in milliseconds, before a {@link org.jasig.cas.client.proxy.ProxyGrantingTicketStorageImpl.ProxyGrantingTicketHolder}
     * is considered expired and ready for removal.
     * 
     * @see org.jasig.cas.client.proxy.ProxyGrantingTicketStorageImpl#DEFAULT_TIMEOUT
     */
