 ...
 * CAS Assertion:
 * <ul>
 * <li>{@link javax.servlet.http.HttpServletRequest#getUserPrincipal()}</li>
 * <li>{@link javax.servlet.http.HttpServletRequest#getRemoteUser()}</li>
 * <li>{@link javax.servlet.http.HttpServletRequest#isUserInRole(String)}</li>
 * </ul>
 * <p/>
